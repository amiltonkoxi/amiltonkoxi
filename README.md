...
| Domain | Technologies |
|-------|--------------|
| **Languages** | Python • C • C++ • TypeScript • SQL • Bash • Verilog |
| **Embedded & Hardware** | STM32 • ESP32 • LoRa (E220) • UART/SPI/I2C • Sensor Networks • FPGA (Zynq-7000, PYNQ-Z2) • Vitis HLS |
| **Cloud & DevOps** | Microsoft Azure • Docker • CI/CD • REST APIs • MySQL • PostgreSQL |
| **Systems & Intelligence** | FastAPI • Next.js • React • OpenCV • ns-3 • ML/AI Fundamentals |
...
📧 **amiltonkoxi2024@outlook.pt**  
🔗 **https://linkedin.com/in/amilton-koxi**
